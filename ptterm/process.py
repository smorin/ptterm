...
class Process(object):
    ...
    :param loop: Prompt_toolkit loop. Used for executing blocking
    ...
    """
    def __init__(self, loop, invalidate, exec_func, bell_func=None,
    ...
    @classmethod
    def from_command(cls, loop, invalidate, command, done_callback,
        ...
        return cls(loop, invalidate, execv,
